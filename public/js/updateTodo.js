...
let todoIndex = localStorage.getItem("todoIndex");
let todos =User.todos[todoIndex].todosElements;
...
function save(){
    let NameTodo = prompt("enter the new  todolist's name")
    const todoSave = {
        todoname: NameTodo,
        todosElements: todos
    }
    User.todos[todoIndex]=todoSave;
    Users[UsrIndex] =User;
